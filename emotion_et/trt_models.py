"""TRT-only token regression models."""
...
class TinyTRTRegressor(torch.nn.Module):
    """Small local backend for smoke tests."""
...
class HFTokenTRTRegressor(torch.nn.Module):
    """RoBERTa-style Hugging Face encoder with a scalar TRT head."""
